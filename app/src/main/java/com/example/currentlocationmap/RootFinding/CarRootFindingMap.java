package com.example.currentlocationmap.RootFinding;
...
public class CarRootFindingMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_root_finding_map);
    ...
    private void requestPermision() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.rootmaping_fragment);
        ...
        switch (requestCode) {
            case LOCATION_REQUEST_CODE: {
                if (grantResults.length > 0
                    ...
                    //init google map fragment to show map.
                    SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                            .findFragmentById(R.id.carAnimation_button_id);
                    mapFragment.getMapAsync(this);
                    // getMyLocation();
